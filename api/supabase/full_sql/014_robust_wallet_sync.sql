-- ============================================================================
-- File: api/supabase/full_sql/014_robust_wallet_sync.sql
-- Purpose: 
--   1. Add missing columns to profiles table.
--   2. Update find_or_create_wallet_user to check both connected_wallets AND wallet_addresses.
--   3. Update link_wallet_to_user to keep both tables in perfect synchronization.
--   4. Ensure case-preservation for Solana wallet addresses.
