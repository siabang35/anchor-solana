import{ac as k,ay as le,R as c,C as pe,h as v,r as V,j as f,k as g,l as d,n as l,a5 as $,I as H,a6 as u,i as me,D as w,v as B,a3 as U,au as fe,ai as F,E as K,a9 as A,P as M,t as we,S as E,ae as z,ar as oe,a4 as be,U as ce,az as ge,aA as ye}from"./index-DILgtjQx.js";import{P as D}from"./index-D-zjEv2c.js";import{S as ve}from"./SwapController-BZWpZ137.js";import"./three-vendor-B-j3nisP.js";import"./react-vendor-CDAdxX5q.js";import"./data-vendor-CHuAUM7I.js";import"./ui-vendor-CaDzUQxD.js";import"./web3-vendor-BAQUMP27.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
