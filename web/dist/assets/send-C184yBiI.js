import{h as x,n as d,a6 as u,j as b,k as v,p as F,G as D,D as g,C as j,ap as l,l as c,q as z,R as h,N as H,U as N,ac as q,S as y,K as Q,J as X,a3 as K,r as Y,i as J,a5 as Z,aw as L,ax as M,E as ee}from"./index-DILgtjQx.js";import"./index-jlLOx0Qv.js";import"./index-DAjTDZK-.js";import{S as G}from"./SwapController-BZWpZ137.js";import"./three-vendor-B-j3nisP.js";import"./react-vendor-CDAdxX5q.js";import"./data-vendor-CHuAUM7I.js";import"./ui-vendor-CaDzUQxD.js";import"./web3-vendor-BAQUMP27.js";const te=x`
  :host {
    width: 100%;
    height: 100px;
...
`;var I=function(e,t,i,r){var o=arguments.length,n=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,i,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(n=(o<3?s(n):o>3?s(t,i,n):s(t,i))||n);return o>3&&n&&Object.defineProperty(t,i,n),n};let C=class extends v{constructor(){super(),this.unsubscribe=[],this.tokenBalances=l.state.tokenBalances,this.search="",this.onDebouncedSearch=D.debounce(t=>{this.search=t}),this.fetchBalancesAndNetworkPrice(),this.unsubscribe.push(l.subscribe(t=>{this.tokenBalances=t.tokenBalances}))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){return c`
    ...
    `}async fetchBalancesAndNetworkPrice(){var t;(!this.tokenBalances||((t=this.tokenBalances)==null?void 0:t.length)===0)&&(await this.fetchBalances(),await this.fetchNetworkPrice())}async fetchBalances(){await l.fetchTokenBalance(),l.fetchNetworkBalance()}async fetchNetworkPrice(){await G.getNetworkTokenPrice()}templateSearchInput(){return c`
