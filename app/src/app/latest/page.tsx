...
function LatestInner() {
    ...
    // Real competition data from backend + Supabase realtime for "latest" sector
    const { competitions, activeCompetition: defaultActiveComp, loading: compLoading } = useCompetitions('latest');
