      ...
      <main className="main-container">
        ...
        <div className="principle-banner animate-in" style={{
          ...
          <div style={{
            ...
            background: 'radial-gradient(ellipse at top left, rgba(168,85,247,0.15) 0%, transparent 50%), radial-gradient(ellipse at bottom right, rgba(236,72,153,0.15) 0%, transparent 50%)',
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <p style={{ color: 'var(--text-muted)', marginTop: '0.4rem' }}>
              Curated competitions based on activity, prize pools, and market potential.
            </p>
          </div>
        </div>

        <SectorNav activeSector="foryou" onSectorChange={() => {}} />
        <SectorFeed sector="foryou" />
      </main>
    </>
  );
}
