                                            ...
                                            >
                                                                ...
                                                                {(() => {
                                                                    ...
                                                                    if (latestPred) {
                                                                        ...
                                                                        if (isSim) {
                                                                            ...
                                                                            badgeColor = '#f59e0b';
                                                                            badgeIcon = '⚙';
                                                                            badgeTitle = 'Generated by Local Deterministic Simulation (API limits active)';
                                                                        } else if (isGroq) {
                                                ...
                                                {/* Prediction Count — uses agentPredictions (same source as curve) */}
                                                    <td style={{
                                                        ...
                                                        color: (agentPredictions?.get(c.agent_id)?.prediction_count || c.prediction_count || 0) >= 3 ? '#818cf8' : '#06b6d4',
                                                        fontSize: '0.6rem',
                                                        transition: 'all 0.4s ease',
                                                    }}>
                                                        {/* Use agentPredictions (same source as curve) with fallback to DB prediction_count */}
                                                        {agentPredictions?.get(c.agent_id)?.prediction_count || c.prediction_count || 0}
                                                        {belowMin && (agentPredictions?.get(c.agent_id)?.prediction_count || c.prediction_count || 0) > 0 && (
