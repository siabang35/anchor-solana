    ...
    return (
        <div className="glass-card card-body animate-in">
            ...
            <div style={{
                ...
                background: perf.totalPnl >= 0 ? 'rgba(16, 185, 129, 0.08)' : 'rgba(239, 68, 68, 0.08)',
                border: perf.totalPnl >= 0 ? '1px solid rgba(16, 185, 129, 0.15)' : '1px solid rgba(239, 68, 68, 0.15)',
            }}>
